...
const getUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const user = yield UserModel_1.UserModel.findOne({ _id: req.decoded.id }, [
            "-refreshToken",
            "-likedApts",
            "-password",
            "-__v",
        ]);
        res.status(200).send(Object.assign(Object.assign({}, responses_1.resTemplate.success.general), { data: user }));
    }
    catch (e) {
        console.error(e);
...
const getProfileImg = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
