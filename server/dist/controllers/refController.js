...
const addUserPreferences = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      yield UserPrefModel_1.UserPrefModel.create({
        userId: req.decoded.id,
        preferences: Object.assign({}, req.body),
      });
...
const updateUserPreferences = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      yield UserPrefModel_1.UserPrefModel.updateOne(
        { userId: req.decoded.id },
        { userId: req.decoded.id, preferences: Object.assign({}, req.body) }
      );
...
const refController = { addUserPreferences, updateUserPreferences };
exports.default = refController;
