  ...
  return (
      <div className="Apartment-container">
        ...
        <div className="Apartment-description">
          <span className="description-text">City:{apt.city}</span>
          <span className="description-text">Price per month:{apt.pricePerMonth}</span>
        </div>
        ...
        <div className="Apartment-like-dislike-div"> 
          <span
              ...
              >
                <i className="fa fa-thumbs-down Apartment-btn-text" aria-hidden="true"></i>
          ...
          <span
              ...
              >
                <i className="fa fa-thumbs-up Apartment-btn-text" aria-hidden="true"></i>
          </span>
        </div>    
      </div>
  );
